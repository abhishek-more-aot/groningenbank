    ...
    <div class="container">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="footer-content-item">
                        <div class="footer-logo">
                            <a href="index.php"><img src="assets/images/logo(test-1).jpg" alt="logo"></a>
                        </div>
                        <div class="footer-details">
                            <p>Unity Finance Care is a personal and business bank with a mission. For 10 years, we have been dedicated to working with our customers, members and partners to create a future-proof society that can overcome important social challenges. </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-lower">
            <div class="footer-lower-item footer-copyright-text">
                <p>Copyright © <?php echo date("Y"); ?> <a href="https://google.co.in/">Unity Finance Care</a></p>
            </div>
